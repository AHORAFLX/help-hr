"""
migrate_sebastian_hr.py
======================
Wrapper específico para descargar todo el producto Sebastian HR reutilizando
migrate.py.

Ventajas:
- fija el filtro `--product Sebastian HR`
- conserva el puente a author_articles.py que ya vive dentro de migrate.py
- evita duplicar la lógica principal de generación

Uso:
    python migrate_sebastian_hr.py
    python migrate_sebastian_hr.py --output-dir . --clean-output
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Descarga todo el producto Sebastian HR reutilizando migrate.py."
    )
    parser.add_argument(
        "--connection-string",
        default="",
    ...
    print("==============================================================")
    print(" Lanzando migrate.py específico para el producto Sebastian HR ")
    print("==============================================================")
