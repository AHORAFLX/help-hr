...
Podemos asignar un tipo de contador para que cuando el empleado realice horas sobre ese turno se añadan al contador indicado. Para más información visitar el siguiente enlace: [Contadores de Horas](Contadores%20de%20Horas.md)
...
![](../../docs_assets/images/y8FhMwgMEwf3SnU7utfD8y4Od9Z-_TKcjQ.png)
  ...
  * Establecer parada mínima: Sirve para indicar que queremos ajustar el tiempo de descanso como mínimo al tiempo establecido en el descanso del turno. (ver [Aplicar descanso mínimo de turno](Aplicar%20descanso%20mínimo%20de%20turno.md))
