...
Los turnos candidatos son aquellos turnos que para un empleado y una fecha de terminada se tendrán en cuenta a la hora el calcular que turno se ajusta mas al conjunto de fichajes del empleado.
...
Rango de reasignación: Cuando seleccionamos la opción "Auto reasignación de Turnos" debemos indicar el rango de reasignación, esto nos indica a que nivel debemos ir a buscar los turnos candidatos y si establecemos un limite a este respecto. Las opciones son las siguientes:
...
A) Total: 
  ...
  1. Se tendrán en cuenta todos lo turnos generales (turnos que no están asignados a ningún objeto)
