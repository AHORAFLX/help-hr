...
Navegas a (`Mantenimiento > Configuración > Aplicación`).

El comportamiento del sistema de fichajes móviles está condicionado por la configuración del parámetro **solicitar ubicación para el marcaje**.
