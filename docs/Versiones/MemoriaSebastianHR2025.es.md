...
- [Nuevo cálculo de asignación de fichaje a jornada (doble parámetro)](../GestionTiempoTrabajo/GuiaDateJourneyAsignacionTurno.es.md): Algoritmo mejorado que utiliza dos parámetros para una asignación más precisa.
