...
Esta configuración puede afectar a cómo Sebastian HR aplica las fechas, así que es necesario disponer de una configuración adecuada para su correcto funcionamiento.
...
Es recomendable instalar la instancia en la collation `Modern_Spanish_CI_AS`.
