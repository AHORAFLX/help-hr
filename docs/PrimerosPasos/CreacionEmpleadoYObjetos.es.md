# Creación de un empleado y configuración de objetos relacionados
...
Nota: En el asistente, puedes optar por no crear el contrato marcando el check "Sin contrato", pero recuerda que es un registro necesario para el resto de funcionalidades de la aplicación.

## 4\. Configuración para la solicitud de vacaciones
...
## 5\. Configuración para que el empleado pueda fichar
