...
En Sebastian HR tenemos que diferenciar entre el idioma de visualización del interfaz y el idioma de los datos maestros.
...
Para cambiar el idioma predeterminado de los datos maestros debemos ir a `Mantenimiento > Parámetros` y seleccionar el proceso de traducción que se requiera.
...
## Asignación de localizaciones por defecto al empleado (para fichaje desde el portal y Access Point)
