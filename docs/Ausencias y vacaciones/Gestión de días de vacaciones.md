...
<table style="width: 100%;"><tbody><tr><td style="width: 100%;background-color: #f7e9b0;"><p style="color: rgb(40, 50, 78);"><span style="color: rgb(40, 50, 78);">Por ejemplo:</span></p><ul style="color: rgb(40, 50, 78);"><li><span style="color: rgb(40, 50, 78);">Una persona empleada tiene <strong>5 días disponibles</strong> en 2024.</span></li><li><span style="color: rgb(40, 50, 78);">Solicita <strong>4 días de vacaciones</strong> para enero de 2025.</span></li><li dir="ltr"><span dir="ltr" style="color: rgb(40, 50, 78);"><strong dir="ltr">Hasta que no se inserten las vacaciones totales de 2025 y se haga el traspaso de días sobrantes de 2024, no quedarán reflejados los días utilizados en enero y se seguirán teniendo 5 días de vacaciones disponibles para 2024</strong>. Más adelante se detalla el posible caso en el que un/a empleado/a tenga más días utilizados que disponibles.</span></li></ul><br/></td></tr></tbody></table>
